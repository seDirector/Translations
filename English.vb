...
Public Class Lang
    ...
    Public Class Notifications
        ...
        Friend Const DesktopShortcutError = "There was an error creating the shortcut. Please make sure you have access to the desktop. Check the log file for more information."
