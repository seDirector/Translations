...
Public Class Lang
    Public Class UI
        Public Class MainWindow
            ...
            Friend Const Information = "資訊"
            Friend Const ServerName = "伺服器名稱"
            Friend Const Created = "建立日期"

            Friend Const Events = "事件"
            Friend Const Logs = "記錄檔"
            Friend Const UptimeUptime = "Uptime"
            Friend Const Started = "Started"
            Friend Const Updated = "Updated"

            Friend Const Properties = "屬性"
            Friend Const Start = "開始"
            Friend Const StopStop = "停止"
            Friend Const Restart = "重新啟動"
            Friend Const ShowHide = "顯示/隱藏"
            Friend Const Update = "更新"
            ...
            Friend Const GameDirectory = "遊戲目錄"
            Friend Const CMDDir = "遊戲目錄命令提示字元"
            Friend Const ConfigFiles = "遊戲設定檔案目錄"
            Friend Const Maps = "遊戲地圖目錄"
            ...
            Friend Const OpenDefDir = "開啟預設目錄"
            Friend Const OpenSL = "開啟 seDirector 記錄檔"
            Friend Const OpenSeDir = "開啟 seDirector 目錄"
            Friend Const Options = "選項"
            Friend Const SupportRequest = "技術支援"
            Friend Const HelpTranslateSed = "協助翻譯 seDirector"
            Friend Const DiscordServer = "Discord 伺服器"
            Friend Const DonateToSed = "贊助 seDirector"
            Friend Const RecFold = "建議的資料夾架構"
        ...
        Public Class ServerProperties
            ...
            Friend Const Properties_UsePrivateIPUnlessOnDMZ = "除非在DMZ後面，不然則使用公共IP"
            Friend Const Properties_NextAvailable = "選擇下一個"
    ...
    Public Class MainWindow
        ...
        Friend Const SentServerCrashEmail = "伺服器當機時傳送電子郵件通知"
        Friend Const SentServerCrashDiscord = "伺服器當機時傳送Discord通知"
    ...
    Public Class Notifications
        ...
        Friend Const ShortcutError = "建立捷徑時發生錯誤，請確定您有訪問桌面的權限。"
        ...
        Friend Const DeleteServerConfirmation = "您確定要刪除伺服器 {0} 嗎?"
        ...
        Friend Const BetaExpired = "此 seDirector 版本已停止支援，請按確定到網站 AsherSoftware.com 取得新版本"
        Friend Const BetaNotificationText = "{0} version - NOT a stable release - some features disabled"
        Friend Const NoAvailableUpdates = "目前沒有可用的更新"
    ...
    Public Class Backups
        Friend Const CreateBackupAsk = "為伺服器 {0} 建立備份?"
        Friend Const CreatingBackupCaption = "建立備份"
        Friend Const BackingUpServer = "備份 {0}"
    End Class
